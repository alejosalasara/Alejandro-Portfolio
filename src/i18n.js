...
window.STRINGS = {
  en: {
    ...
    'about.body': "I'm Alejandro, a growth-focused UX/UI designer and email marketer based in Colombia. I find the 30% leaking out of your DTC store: in the product page, the cart, the emails you're not sending, and design it back in. Strategy, interface, and revenue, end to end.",
    ...
    'works.4.meta': 'Lifecycle · Retention', 'works.4.tag': 'Email Marketing',
  ...
  es: {
    ...
    'about.body': 'Soy Alejandro, diseñador UX/UI enfocado en growth y email marketer desde Colombia. Encuentro el 30% que se escapa de tu tienda DTC: en la página de producto, el carrito, los emails que no estás enviando, y lo diseño de vuelta. Estrategia, interfaz y revenue, de punta a punta.',
    ...
    'works.4.meta': 'Ciclo de vida · Retención', 'works.4.tag': 'Email Marketing',
